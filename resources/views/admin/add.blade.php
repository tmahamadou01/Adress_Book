            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">Nom</label>
                            <input name="nom" type="text" class="form-control" placeholder="ex: Entrez votre nom">
                            @if ($errors->has('nom'))
                                <span>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="prenom" type="text" class="form-control" placeholder="ex: Entrez votre prenom">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="adresse1" type="text" class="form-control" placeholder="ex: Entrez votre adresse 1">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="adresse2" type="text" class="form-control" placeholder="ex: Entrez votre adresse 2">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="code_postal" type="text" class="form-control" placeholder="ex: Entrez votre code postal">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="ville" type="text" class="form-control" placeholder="ex: Entrez votre ville">
                            @if ($errors->has('ville'))
                                <span>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="numero" type="text" class="form-control" placeholder="ex: Entrez votre numero">
                ...
                <div class="form-group"><br>
                    {{ Form::submit('AJOUTER', array('class' => 'btn btn-md btn-block btn-primary', 'id'=> 'button_add_contact')) }}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
