    ...
    <div class="container">
        ...
        <div class="row" style="padding: 1em;">
            <div class="col-sm-12">
                ...
                {!! Form::open(['method' => 'put', 'url' => route('contact.update', $contact)]) !!}
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('civilite', 'civilite') !!}
                            {!! Form::select('civilite',array(
                                'Mr' => 'Mr',
                                'Mme' => 'Mme',
                                'Mlle' => 'Mlle'
                                ),$contact->civilite, ['class' => 'form-control', 'placeholder' => 'Selectionner votre civilite ...'])
                            !!}
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">Nom</label>
                            <input name="nom" type="text" class="form-control" placeholder="ex: Entrez votre nom" value="{{$contact->nom}}">
                            @if ($errors->has('nom'))
                                <span>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="prenom" type="text" class="form-control" placeholder="ex: Entrez votre prenom" value="{{$contact->prenom}}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="adresse1" type="text" class="form-control" placeholder="ex: Entrez votre adresse 1" value="{{$contact->adresse1}}">
                            @if ($errors->has('adresse1'))
                                <span>
                                    <ul class="basic_error"><li>{{ $errors->first('adresse1') }}</li></ul>
                                </span>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="adresse2" type="text" class="form-control" placeholder="ex: Entrez votre adresse 2" value="{{$contact->adresse2}}">
                            @if ($errors->has('adresse2'))
                                <span>
                                    <ul class="basic_error"><li>{{ $errors->first('adresse2') }}</li></ul>
                                </span>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="code_postal" type="text" class="form-control" placeholder="ex: Entrez votre code postal" value="{{$contact->code_postal}}">
                            @if ($errors->has('code_postal'))
                                <span>
                                    <ul class="basic_error"><li>{{ $errors->first('code_postal') }}</li></ul>
                                </span>
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="ville" type="text" class="form-control" placeholder="ex: Entrez votre ville" value="{{$contact->ville}}">
                            @if ($errors->has('ville'))
                                <span>
                                    <ul class="basic_error"><li>{{ $errors->first('ville') }}</li></ul>
                                </span>
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="pays" class="form-control">
                                ...
                                <option value="France" title="France" selected>France</option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="numero" type="text" class="form-control" placeholder="ex: Entrez votre numero" value="{{$contact->numero}}">
                            @if ($errors->has('numero'))
                                <span>
                                    <ul class="basic_error"><li>{{ $errors->first('numero') }}</li></ul>
                                </span>
                            @endif
                        </div>
                    </div>
                ...
                <div class="form-group"><br>
                    {{ Form::submit('MODIFIER', array('class' => 'btn btn-md btn-block btn-primary', 'id'=> 'button_add_contact')) }}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
